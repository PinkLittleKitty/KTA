        ...
        public override void OnInspectorGUI() {
            ...
            if (_effect.method != XFRAME_DOWNSAMPLING_METHOD.Disabled) {
                ...
                if (_effect.method == XFRAME_DOWNSAMPLING_METHOD.AdaptativeDownsampling) {
                    ...
                    if (_effect.compositingMethod != XFRAME_COMPOSITING_METHOD.LightweightRenderingPipeline) {
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label(new GUIContent("Enable Nice FPS", "Enables or disabled Nice FPS feature. If FPS exceeds this value, XFrame will be disabled. If FPS goes down, XFrame will be enabled again. Pump up this value to the max if you don't want XFrame to be disabled."), GUILayout.Width(110));
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label(new GUIContent("Enable Click Events", "Uses Raycasting to send mouse events on scene gameobjects that require them."), GUILayout.Width(110));
