...
public class MaterialesCol : MonoBehaviour {
    ...
    private readonly Color32 azul = new Color32(143, 0, 254, 1);
    private readonly Color azul2 = new Color(0.6274509803921569f, 0.1254901960784314f, 0.9411764705882353f);
    private readonly Color azul3 = new Color(0.3137254901960785f, 0.0627450980392157f, 0.4705882352941177f);

    private readonly Color32 naranja = new Color32(255, 0, 0, 0);
    private readonly Color naranja2 = new Color(1, 0, 0);
    private readonly Color naranja3 = new Color(0.5f, 0, 0);
